...
| A9 | P1 | 페이지 갱신 요청(IndexNow/Naver) 루틴 | 변경 후 갱신 요청 자동/반자동 가능 | Actions 후보 |
...
| ID | 우선순위 | 작업 | 성공 기준 | 비고 |
|---|---|---|---|---|
| C1 | P0 | 이번 주 접수 마감 허브 | 주간 검색 유입 확보 | 편집형 |
| C2 | P0 | 서울/수도권 대회 허브 | 지역 키워드 유입 | 편집형 |
| C3 | P0 | 부산/영남 대회 허브 | 지역 키워드 유입 | 편집형 |
| C4 | P0 | 10K 추천 허브 | 초보 검색 의도 대응 | 편집형 |
| C5 | P0 | 하프/풀 추천 허브 | 숙련 검색 의도 대응 | 편집형 |
